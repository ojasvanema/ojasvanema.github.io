...
<div class="experience-section mb-5">
  ...
  <div class="job py-3 border-bottom">
    <div class="row">
      ...
      <div class="col-md-3 text-md-right text-muted">
        <small>Sep 2025 &ndash; Present</small>
      </div>
    </div>
    <div class="mt-2">
      <p>
      ...
      <ul>
        <li>Investigating <strong>Bilinear MLPs</strong> to design more interpretable neural architectures. <a href="https://arxiv.org/abs/2602.05635">[Read Paper]</a></li>
  ...
  <div class="job py-3 border-bottom">
    <div class="row">
      ...
      <div class="col-md-3 text-md-right text-muted">
        <small>Nov 2025 &ndash; Jan 2026</small>
      </div>
    </div>
    <div class="mt-2">
